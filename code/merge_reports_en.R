...
report_dir <- file.path(cfg$paths$reports, "reports_English")
...
# 4. Sauvegarde finale
final_docx <- file.path(report_dir, "Full_Study_Combined_Report_EN.docx")
final_pdf  <- file.path(report_dir, "Full_Study_Combined_Report_EN.pdf")
